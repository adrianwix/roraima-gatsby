  ...
  <Layout>
    <section>
      <div className="container-fluid">
        ...
        <div className="cover">
          <img src={withPrefix("img/tucan-airways/COVER-TUCAN.jpg")} alt="" className="img-fluid"/>
        </div>
          ...
          <div data-aos="fade-left" className="row p-4">
            <div className="col text-center">
              <p className="p">Tucan Airways is a partnered Low-Cost Airline member of the Roraima Group founded by
                Roraima
                Airlines, based in SVVA, that have and small fleet of regional jets that makes flights inside
                Venezuela to the same Roraima Regional destinations and even airports and places were Roraima do
                not, it's logo blue color schemes and Toucan bird silhoutte makes a full representation of the
                total commitment with the environment protection established by Roraima Airlines, also using the
                same Nature conservation philosophies as Roraima does.
              </p>
            </div>
          </div>
              ...
              <div id="carousel1" className="carousel slide" data-interval="false" data-ride="carousel">
                ...
                <div className="carousel-inner" role="listbox">
                  <div className="carousel-item active">
                    <img className="d-block img-fluid" src={withPrefix("img/tucan-airways/YV800T.png")} alt="First slide"/>
          ...
          <div data-aos="fade-left" className="row mt-4">
            ...
            <div className="col-md-8">
              ...
              <div id="carousel1" className="carousel slide" data-interval="false" data-ride="carousel">
                ...
                <div className="carousel-inner" role="listbox">
                  <div className="carousel-item active">
                    <img className="d-block img-fluid" src={withPrefix("img/tucan-airways/Q400.png")} alt="First slide"/>
                      <p className="text-center" style={{fontSize: "10px"}}>Aircraft templates by <a
                        href="http://www.airline-empires.com/" rel="noopener noreferrer" target='_blank'>MedAviation</a>.</p>
                      <div className="carousel-caption d-block">
                        <h3>AIRCRAFT INFO</h3>
