    ...
    <section>
      <div className="cointainer-fluid">
        ...
        <div className="container">
          ...
          <h2 className="mt-4 animated fadeInLeft">RORAIMA GROUP</h2>
          <div className="separador"/>

          <div className="row">
            <div className="col">
              <p className="text-center p-4 my-4" style={{ fontSize: "1.5em"}}>
          ...
          <div className="row justify-content-center mb-4">
            <div className="col-12 col-md-6 text-center borderRcargo">
