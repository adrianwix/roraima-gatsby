  ...
  <Layout>
    <section>
      <div className="container-fluid">
        <div className="cover">
          <img
            src={withPrefix('img/cover/COVER-CG.jpg')}
            alt=""
            className="img-fluid"
          />
        </div>
        ...
        <div className="container">
          ...
          <div className="row p-4">
            <div className="col text-center">
              <p data-aos="fade-left" className="p">
                Roraima Cargo is a partnered Cargo Carrier member of the Roraima
                Group founded by Roraima Airlines, based in SVMI, that have
                fleet a of Cargo jets with which can offer the service of parcel
                transportation through air delivery out of commercial and
                passenger aviation gateways to anywhere this Cargo jets can fly
                and land, to accomplish every request assigned by the client.
              </p>
            </div>
          </div>
          ...
          <div className="row mt-3">
            <div className="col">
              <h2 data-aos="fade-left">CARGO FLEET</h2>
              <div className="separador" />
            </div>
          </div>
                ...
                <div className="carousel-inner" role="listbox">
                  <div className="carousel-item active">
                    <img
                      ...
                      src={withPrefix('img/roraima-cargo/Boeing-777F.png')}
                      alt="First slide"
                    />
          ...
          <div className="row justify-content-center rowtucanlogo">
            <div data-aos="fade-left" className="col-md-7 text-center">
              <img
